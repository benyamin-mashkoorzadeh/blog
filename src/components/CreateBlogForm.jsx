...
import {useAddNewBlogMutation} from "../api/apiSlice.js";
    ...
    return (
        <section>
            ...
            <form autoComplete="off">
                ...
                <label htmlFor="blogAuthor">نویسنده پست : </label>
                <select name="blogAuthor" id="blogAuthor" onChange={onAuthorChange}>
